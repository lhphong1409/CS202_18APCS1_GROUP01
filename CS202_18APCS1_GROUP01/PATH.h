...
const std::string image_vehicle_car = "image/vehicle/car/car2.bmp";
const std::string image_vehicle_truck = "image/vehicle/truck/truck1.bmp";
const std::string image_vehicle_bus = "image/vehicle/bus/bus1.bmp";
